<template>
    <Head title="Staff Loans" />

    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Staff Loans</h2>
        </template>
...
const deleteLoan = (loan) => {
    if (confirm('Are you sure you want to delete this loan?')) {
        router.delete(route('staff-loans.destroy', loan.id));
    }
};
</script>]]>
