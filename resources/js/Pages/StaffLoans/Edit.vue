<template>
    <Head title="Edit Staff Loan" />

    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Edit Staff Loan</h2>
        </template>
...
const submit = () => {
    form.put(route('staff-loans.update', props.loan.id));
};
</script>]]>
