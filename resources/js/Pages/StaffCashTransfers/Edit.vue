...
const form = useForm({
    staff_id: props.transfer.staff_id,
...
const submit = () => {
    form.put(route('staff-cash-transfers.update', props.transfer.id));
};
</script>
                    ...
                    <div class="p-6">
                        <form @submit.prevent="submit" class="space-y-6">
                            ...
                            <div class="flex items-center justify-end space-x-4">
                                <SecondaryButton @click="$inertia.visit(route('staff-cash-transfers.show', transfer.id))">
                                    Cancel
                                </SecondaryButton>
