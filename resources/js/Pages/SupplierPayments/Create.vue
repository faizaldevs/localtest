    ...
    <AuthenticatedLayout>
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="overflow-auto max-h-[600px] border border-gray-200 rounded-lg">                    <table v-if="suppliers.length" class="min-w-full divide-y divide-gray-200">                        <thead class="sticky top-0 z-20">
                            <tr>
                                <th class="px-6 py-3 bg-gray-50 text-left text-xs font-medium text-gray-500 uppercase tracking-wider supplier-column border-r border-gray-200">Supplier</th>
                            ...
                            <tr v-for="supplier in suppliers" :key="supplier.id">
                                <td class="px-6 py-4 whitespace-nowrap supplier-column border-r border-gray-200">
                                    {{ supplier.name }}
                                </td>
...
table thead th.supplier-column {
    position: sticky;
    left: 0;
    z-index: 31;
}

table tbody td.supplier-column {
    position: sticky;
    left: 0;
...
table tfoot td.supplier-column {
    position: sticky;
    left: 0;
    background-color: rgb(249 250 251);
    z-index: 30;
